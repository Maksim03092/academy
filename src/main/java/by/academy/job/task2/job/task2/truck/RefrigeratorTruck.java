...
public class RefrigeratorTruck extends Truck {
    ...
    public RefrigeratorTruck(int yearOfRelease, String carBrand, String modelCar, String typeFuel,
                             String fuelConsumption, double cargoVolume, int loadCapacity, String bodyType,
